...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='bitcoinhard.conf'
CONFIGFOLDER='/root/.bitcoinhard'
COIN_DAEMON='bitcoinhardd'
COIN_CLI='bitcoinhard-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/zoldur/BitcoinHard/releases/download/v1.0.0/bitcoinhard.tar.gz'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='Bitcoinhard'
COIN_PORT=6006
RPC_PORT=6005
